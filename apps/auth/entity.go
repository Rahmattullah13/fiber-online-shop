...
func (a AuthEntity) VarifyPasswordFromEncrypted(plain string) (err error) {
...
func (a AuthEntity) GenerateToken(secret string) (token string, err error) {
